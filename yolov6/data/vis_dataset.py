...
def main(args):
    ...
    for file in tqdm(os.listdir(img_dir)):
        ...
        try:
            ...
            # cv2.waitKey(0)
            cv2.imwrite('./showimg/out_{}'.format(file),img_data)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--img_dir', default='../../../CarPersonDataSet/images')
    parser.add_argument('--label_dir', default='../../../CarPersonDataSet/labels')
    parser.add_argument('--class_names', default=['car', 'person'])
