...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--weights', type=str, default='./pt/v2/best_ckpt.pt', help='model path(s) for inference.')
    parser.add_argument('--source', type=str, default='./onnx/imgs', help='the source path, e.g. image-file/dir.')
    ...
    parser.add_argument('--yaml', type=str, default='./data/bflocal.yaml', help='data yaml file.')
    ...
    parser.add_argument('--iou-thres', type=float, default=0.25, help='NMS IoU threshold for inference.')
    parser.add_argument('--max-det', type=int, default=150, help='maximal inferences per image.')
