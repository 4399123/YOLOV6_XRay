...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--conf-file', default='./configs/repopt/yolov6s_opt_qat.py', type=str, help='experiments description file')
    ...
    parser.add_argument('--output-dir', default='./runs/opt_train_v6s_qat', type=str, help='path to save outputs')
    ...
    parser.add_argument('--distill', default=True, help='distill or not')
    parser.add_argument('--distill_feat', default=True, help='distill featmap or not')
    parser.add_argument('--quant', default=True, help='quant or not')
    parser.add_argument('--calib', action='store_true', help='run ptq')
    parser.add_argument('--teacher_model_path', type=str, default='./yolov6_assert/yolov6s_v2_reopt_43.1.pt', help='teacher model path')
    parser.add_argument('--temperature', type=int, default=20, help='distill temperature')
    parser.add_argument('--fuse_ab', default=False, help='fuse ab branch in training process or not')
