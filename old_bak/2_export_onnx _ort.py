...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='./pt/catdogv2.pt', help='weights path')
    ...
    parser.add_argument('--conf-thres', type=float, default=0.6, help='conf threshold for NMS')
    ...
    try:
        ...
        if not os.path.exists('./onnx'):
            os.makedirs('./onnx')
        export_file ='./onnx/best-ort.onnx'
