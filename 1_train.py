...
def get_args_parser(add_help=True):
    ...
    #需修改的参数
    parser.add_argument('--data-path', default='./data/bflocal.yaml', type=str, help='path of dataset')
    parser.add_argument('--conf-file', default='./configs/yolov6m_finetune.py', type=str, help='experiments description file')
    parser.add_argument('--epochs', default=320, type=int, help='number of total epochs to run')
    ...
    parser.add_argument('--device', default='0,1', type=str, help='cuda device, i.e. 0 or 0,1,2,3 or cpu')
